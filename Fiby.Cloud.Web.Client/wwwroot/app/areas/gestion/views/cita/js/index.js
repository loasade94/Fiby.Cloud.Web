var citajs = {
    ...
    openModal: function (idCita) {
        var url = '/Gestion/Cita/RegisterUpdate';
        $.get(url, {
            idCita: idCita
        }, function (data) {
    ...
    buscarPacienteModal: function () {
        ...
        $.ajax({
            ...
            url: '/Gestion/Cita/GetPacientePorDocumento',
            // dataType: "json",
            beforeSend: function () {
                $('#loading-screen').show();
            },
    ...
    buscarDoctorEspecialidadModal: function () {
        ...
        $.ajax({
            ...
            url: '/Gestion/Cita/GetDoctorPorEspecialidad',
            // dataType: "json",
            beforeSend: function () {
                $('#loading-screen').show();
            },
