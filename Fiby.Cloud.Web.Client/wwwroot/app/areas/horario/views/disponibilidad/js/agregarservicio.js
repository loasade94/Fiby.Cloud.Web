    ...
    initializeCliente: function () {
        ...
        $.widget("custom.combobox", {
            ...
            _createAutocomplete: function () {
                ...
                this.input = $("<input>")
                    ...
                    .autocomplete({
                        ...
                        change: function () {
                            agregarserviciojs.buscarClientePorCodigo()
                        }
                    })
                    .tooltip({
                        classes: {
            ...
            _removeIfInvalid: function (event, ui) {
                ...
                if (valid) {
                    agregarserviciojs.valorCliente = value;
                    return;
                } else {
...
$(function () {
   ...
   /* agregarserviciojs.initializeEvent();*/
    agregarserviciojs.initializeCliente();
