var pacientejs = {
    ...
    openModal: function (idPaciente) {
        var url = '/Mantenimiento/Paciente/RegisterUpdate';
        $.get(url, {
    ...
    registrarPaciente_callback: function () {
        ...
        $.ajax({
            ...
            url: '/Mantenimiento/Paciente/GuardarPaciente',
            // dataType: "json",
            beforeSend: function () {
                $('#loading').show();
            },
    ...
    buscarPaciente: function () {
        ...
        $.ajax({
            ...
            //},
            url: '/Mantenimiento/Paciente/GetPacienteAll',
            // dataType: "json",
            beforeSend: function () {
                $('#loading-screen').show();
            },
    ...
    eliminarPaciente_callback: function (obj) {
        ...
        $.ajax({
            ...
            url: '/Mantenimiento/Paciente/EliminarPaciente',
            success: function (response, textStatus, jqXhr) {
